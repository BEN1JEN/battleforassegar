function love.conf(t)
    t.identity = ".battleforassegar"    -- The name of the save directory (string)
    t.version = "0.9.2"                 -- The LÖVE version this game was made for (string)
    t.console = true                    -- Attach a console (boolean, Windows only)
 
    t.window.title = "battleforassegar" -- The window title (string)
    ...
    t.window.minheight = 150            -- Minimum window height if the window is resizable (number)
